...
String apikey       = "The openweathermap API Key";                      // See: https://openweathermap.org/
...
String City             = "The City Name";                 // Your home city See: http://bulk.openweathermap.org/sample/
String Latitude         = "";                              // Latitude of your location in decimal degrees, you can find it from Googlemap by right click at the location
String Longitude        = "";                              // Longitude of your location in decimal degrees, you can find it from Googlemap by right click at the location
String WFStation        = "3400TH";                        // Station ID for getting the waterfloat rate information, get it from http://environment.data.gov.uk
...
const char* Timezone    = "GMT0BST,M3.5.0/1,M10.5.0";      // Choose your time zone from: https://github.com/nayarsystems/posix_tz_db/blob/master/zones.csv 
...
String agileTariffLocation = "AGILE-FLEX-22-11-25";        // The Agile Tariff of your Octopus Account
